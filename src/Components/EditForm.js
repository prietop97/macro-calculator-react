          ...
          <div className="birthdate">
            ...
            <div className="birthdate-inputs">
              <select
                ...
                required
                value={formValues.birthdate_month}
              >
                <option value="" required>
                  Month
                </option>
                {month.map((mon, index) => (
                  <option key={index} value={mon.monthNumber}>
                    {mon.monthString}
                  </option>
                ))}
              </select>
              <select
                ...
                name="birthdate_day"
                required
                value={formValues.birthdate_day}
              >
              ...
              <select
                ...
                name="birthdate_year"
                required
                value={formValues.birthdate_year}
              >
          ...
          <div className="height">
            ...
            <div className="height-inputs">
              ...
              <select
                ...
                name="inches"
                required
                value={height.inches % 12}
              >
                <option value="" required>
                  Inches
                </option>
                {inches.map((inch, index) => (
          ...
          <div className="single-line">
            ...
            <div className="single-line">
              ...
              <select
                ...
                onChange={handleChange}
                required
                value={formValues.activity_factor}
              >
                <option value="">Please Choose An Option</option>
            ...
            <div className="single-line">
              ...
              <select
                onChange={handleChange}
                name="goal_multiplier"
                required
                value={formValues.goal_multiplier}
              >
                <option value="">Please Choose An Option</option>
                <option value={0.8}>
